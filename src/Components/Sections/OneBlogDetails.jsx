  ...
  return (
    <div className="p50-section">
      <div className="w-[900px] m-auto">
        <p className="fw-500 color8 leading-7 pb-6 max-w-[100%]">
        ...
        <h2 className="secondary-clr pb-4 fw-600 fw-600 text-4xl max-w-[100%] leading-[80px]">
        ...
        <img
          src={image}
          alt="image"
          className="rounded-2xl pb-6 w-[900px] m-auto"
        />
        <p className="fw-500 color8 leading-7 pb-6 max-w-[100%]">
          Now, the paradigm has shifted. The question is not why you should
          include a content marketing strategy, but how you should do it has
        ...
        <ul className="list-disc pl-4">
          <li className=" fw-500 color8 leading-7 pb-3 max-w-[100%]">

    ...
    <div className="bg-primary-clr p100-section">
      <div className="Wrapper">
        <h1
          ...
          className="secondary-clr sm:text-4xl text-3xl fw-700 text-center max-w-[600px] sm:leading-[60px] m-auto"
        >
          {title}
        </h1>
        <p
          ...
          data-aos-delay="300"
          data-aos-duration="800"
          className="text-center color8 m-auto max-w-[600px] py-6 leading-7 fw-500"
        >
          {description}
        </p>
        <div
          ...
          data-aos-delay="400"
          data-aos-duration="800"
          className="grid md:grid-cols-3 sm:grid-cols-2 gap-8 pt-16"
        >
          {List.map((item, i) => {
            return (
